...
class MainWebApp extends StatelessWidget {
  MainWebApp({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    String url = 'https://maps.googleapis.com/maps/api/js?key=${dotenv.env['GMAP_API_KEY']}';
    var scriptTag = html.document.getElementById("map_script");

    if(scriptTag != null && scriptTag.getAttribute('src') != url){
